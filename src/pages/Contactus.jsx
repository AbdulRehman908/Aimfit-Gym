...
<div className="container-fluid bg-primary p-5 bg-hero mb-5">
  <div className="row py-5">
    <div className="col-12 text-center">
      <h1 className="display-2 text-uppercase text-white mb-md-4">Contact Us</h1>
  ...
  <div className="row g-5 mb-5">
    <div className="col-lg-4">
      <div className="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
        ...
        <h5 className="text-uppercase text-info">Visit Us</h5>
        <p className="text-secondary mb-0">Muscle Factory Gym,
...
Pakistan</p>
    ...
    <div className="col-lg-4">
      <div className="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
        ...
        <h5 className="text-uppercase text-info">Email Us</h5>
        <p className="text-secondary mb-0">aimfit@gmail.com</p>
      </div>
    </div>
    <div className="col-lg-4">
      <div className="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
        ...
        <h5 className="text-uppercase text-info">Call Us</h5>
        <p className="text-secondary mb-0">+92-3154896745</p>
      </div>
    </div>
  </div>
