...
<div className="container-fluid bg-primary p-5 bg-hero mb-5">
  <div className="row py-5">
    <div className="col-12 text-center">
      <h1 className="display-2 text-uppercase text-white mb-md-4">Testimonials</h1>
      <a href className="btn btn-info py-md-3 px-md-5 me-3">Home</a>
      <a href className="btn btn-light py-md-3 px-md-5">Testimonials</a>
    </div>
  </div>
</div>
    ...
    <div className="col-lg-6 bg-dark p-5">
      ...
      <div className="owl-carousel testimonial-carousel">
        <div className="testimonial-item">
          <p className="fs-4 fw-normal text-light mb-4">The variety of classes offered is phenomenal. Whether I'm in the mood for an intense HIIT session, a calming yoga class, or a fun Zumba dance-off, there's always something exciting to participate in. The instructors are highly knowledgeable and truly passionate about helping us achieve our fitness goals. They provide personalized attention and adapt the workouts to cater to all fitness levels.</p>
