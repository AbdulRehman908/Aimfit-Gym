        ...
        <div className="row gx-5">
          <div className="col-lg-4 col-md-12 pt-5 mb-5">
            ...
            <div className="d-flex mb-2">
              <i className="bi bi-geo text-info me-2"/>
              <Link to={"/"}><p className="mb-0">Muscle Factory Gym,
Plot No. 25, Block H, Gulberg III,
Lahore, 54660,
Pakistan</p></Link>
            </div>
            <div className="d-flex mb-2">
              <i className="bi bi-envelope-open text-info me-2" />
              <Link>
              <p className="mb-0">aimfit@gmail.com</p>
              </Link>
            </div>
            <div className="d-flex mb-2">
              <i className="bi bi-telephone text-info me-2" />
              <Link>
              <p className="mb-0">+92-3154896745</p></Link>
            </div>
            {/* <div className="d-flex mt-4">
              <a className="btn btn-info btn-square rounded-circle me-2" href="#"><i className="fab fa-twitter" /></a>
              <a className="btn btn-info btn-square rounded-circle me-2" href="#"><i className="fab fa-facebook-f" /></a>
              <a className="btn btn-info btn-square rounded-circle me-2" href="#"><i className="fab fa-linkedin-in" /></a>
              <a className="btn btn-info btn-square rounded-circle" href="#"><i className="fab fa-instagram" /></a>
            </div> */}
    ...
    <div className="tooltip">Telegram</div>
          ...
          <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
            ...
            <div className="d-flex flex-column justify-content-start">
              <a className="text-secondary mb-2" href="#" ><i className="bi bi-arrow-right text-info me-2" />Home</a>
              <a className="text-secondary mb-2" href="#"><i className="bi bi-arrow-right text-info me-2" />About Us</a>
              <a className="text-secondary mb-2" href="#"><i className="bi bi-arrow-right text-info me-2" />Class Schedule</a>
              <a className="text-secondary mb-2" href="#"><i className="bi bi-arrow-right text-info me-2" />Our Trainers</a>
              <a className="text-secondary mb-2" href="#"><i className="bi bi-arrow-right text-info me-2" />Equipments</a>
              <a className="text-secondary" href="#"><i className="bi bi-arrow-right text-info me-2" />Contact Us</a>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
            ...
            <div className="d-flex flex-column justify-content-start">
              ...
              <a className="text-secondary mb-2" href="#"><i className="bi bi-arrow-right text-info me-2" />Class Schedule</a>
              <a className="text-secondary mb-2" href="#"><i className="bi bi-arrow-right text-info me-2" />Our Trainers</a>
              <a className="text-secondary mb-2" href="#"><i className="bi bi-arrow-right text-info me-2" />Equipments Blog</a>
              <a className="text-secondary" href="#"><i className="bi bi-arrow-right text-info me-2" />Contact Us</a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-info p-5">
          ...
          <p className="text-light">Get notified with our latest news and updates.</p>
          <form action>
    ...
    <div className="row gx-5">
      <div className="col-lg-8">
        <div className="py-lg-4 text-center">
          <p className="text-secondary mb-0">© <a className="text-light fw-bold" href="#">AimFit Lahore</a>. All Rights Reserved.</p>
        </div>
      </div>
      <div className="col-lg-4">
        <div className="py-lg-4 text-center credit">
          <p className="text-light mb-0">Designed by <a className="text-light fw-bold" href="#">Abdul Rehman</a></p>
        </div>
      </div>
    </div>
  </div>
