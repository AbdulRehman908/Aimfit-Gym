        ...
        <div className="row gx-0 bg-secondary d-none d-lg-flex">
          <div className="col-lg-7 px-5 text-start">
            <div className="h-100 d-inline-flex align-items-center py-2 me-4"> 
              <i style={{color: "	#3e65cf"}} className="fa fa-envelope me-2" />
              <h6 className="mb-0">AimFit@gmail.com</h6>
            </div>
            <div className="h-100 d-inline-flex align-items-center py-2">
              <i style={{color: "	#3e65cf"}} className="fa fa-phone-alt me-2" />
              <h6 className="mb-0">+92-3154896745</h6>
            </div>
    ...
    <span className="button_text">Download Now</span>
          ...
          <div className="col-lg-5 px-5 text-end">
            {/* <div className="d-inline-flex align-items-center py-2">
              <a className="btn btn-info btn-square rounded-circle me-2" href>
              ...
              <a className="btn btn-info btn-square rounded-circle" href>
    ...
    <div className="tooltip">Telegram</div>
        ...
        <nav className="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
          <a href="index.html" className="navbar-brand d-block d-lg-none">
            <h1 className="m-0 display-4 text-primary text-uppercase">AimFit</h1>
          </a>
          ...
          <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div className="navbar-nav mr-auto py-0">
               ...
               <NavLink to="/About" className="nav-item nav-link " > Aboutus  </NavLink>

               <NavLink to="/classes" className="nav-item nav-link " > Classes  </NavLink>

              <NavLink to="/trainers" className="nav-item nav-link">Trainers</NavLink>

             <NavLink to="equipments" className="nav-item nav-link">Equipments</NavLink>
            ...
            <a href className="btn btn-info py-md-2 px-md-4 d-none d-lg-block">Join Us Here</a>
          </div>
        </nav>
      </div>
    </div>
